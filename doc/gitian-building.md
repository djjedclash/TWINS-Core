...
git clone https://github.com/twins-crypto/twins.git
cd twins
...
```bash
    ...
    From https://github.com/twins-crypto/twins
...
[twins/gitian.sigs](https://github.com/twins-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
