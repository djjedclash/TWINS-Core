/* src/config/twins-config.h.  Generated from twins-config.h.in by configure.  */
/* src/config/twins-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.twins.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "TWINS Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TWINS Core 3.1.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "twins"
